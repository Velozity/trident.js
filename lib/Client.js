...
class TridentClient extends Client {
  ...
  async _registerEvents() {
    const tempDirPath = path.dirname(require.main.filename).endsWith('\\config') ? path.dirname(require.main.filename).replace('\\config', '') : path.dirname(require.main.filename);
